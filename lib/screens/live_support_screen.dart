    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.support_agent, size: 80, color: AppTheme.goldColor.withOpacity(0.5)),
            const SizedBox(height: 16),
            const Text('الدعم المباشر', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
