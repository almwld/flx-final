    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.description, size: 80, color: AppTheme.goldColor.withOpacity(0.5)),
            const SizedBox(height: 16),
            const Text('تفاصيل الإعلان', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
